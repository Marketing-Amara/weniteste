...
<body>
<div style="background:#F5A623;color:#1a1a1a;text-align:center;font-weight:800;font-size:12.5px;padding:7px;letter-spacing:.04em;text-transform:uppercase;position:sticky;top:0;z-index:999;font-family:'Lato',sans-serif;">
  HOMOLOGAÇÃO (TESTE) — não é o funil oficial
</div>
<header>
  <div class="hd-top">
